...
//}
//
//// 1/2 + 2/5 = Effective function
////string Adding_two_fractions(int a, int b, int c, int d)
////{
////	// Вычисляем НОК знаменателей
////	int Least_common_multiple = b * d;
////
////	// // Приводим дроби к общему знаменателю
////	int Common_denominator1 = a * d;
////	//int Common_denominator2 = b * d;
////	int Common_denominator3 = c * b;
////	//int Common_denominator4 = d * b;
////
////	// Складываем числители
////	int numerators = Common_denominator1 + Common_denominator3;
////	/*int denominators = Common_denominator2 + Common_denominator4;*/
////	int denominators = Least_common_multiple;
////
////	// Форматируем результат в виде строки
////	string s_numerators = to_string(numerators);
////	string s_denominators = to_string(denominators);
////	string s_result = s_numerators + "/" + s_denominators;
////
////	return s_result;
////
////
